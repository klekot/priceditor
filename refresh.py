...
def refresh(query, names_col, textbox, textbox_1, params_col, explain_col, img_source_entry, \
    ...
    for i in range(len(names_col)):
        if names_col[i] == query:
            ...
            pilim_dev.thumbnail(size_dev, PIL.Image.ANTIALIAS)
            ...
            pilim_dim.thumbnail(size_dim, PIL.Image.ANTIALIAS)
            ...
            pilim_schm1.thumbnail(size_schm1, PIL.Image.ANTIALIAS)
            ...
            pilim_schm2.thumbnail(size_schm2, PIL.Image.ANTIALIAS)
